...
if ($system["system_public"] && !in_array($_POST['get'], ["newsfeed", "posts_profile", "posts_page", "posts_group", "posts_event", "suggested_pages", "suggested_groups", "suggested_events", "articles","articles_test", "category_articles", "fundings", "games", "search_posts", "search_articles", "search_users", "search_pages", "search_groups", "search_events"])) {
  user_access(true);
}
