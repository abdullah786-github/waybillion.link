      ...
      <form class="js_ajax-forms" data-url="core/signin.php" method="POST">
         ...
         <div class="form-group">
            <div class="input-group">
              ...
              <select name="sign_method" id="signmethod" class="form-control" required>
                      ...
                      <option value="" disabled selected>{__("Login via")}</option>
                    <option value="ByPhone">{__("Mobile Number")}</option>
                    <option value="ByEmail">{__("Email")}</option>
              </select>
            </div>
          </div>
        ...
        <div class="form-group" id="username_email">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder='{__("Email")} {__("or")} {__("Username")}' name="username_email">
          </div>
        </div>
         <div class="form-group"  id="Phone">
          <div class="input-group">
            <div class="input-group-prepend">
              ...
              <input id="phone_num" name="phone" type="text" class="form-control" placeholder='{__("Phone number")}'>
          </div>
        </div>
        ...
        <div class="form-group">
          <h2 class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill send_otp">{__("Send")}</h2>
        </div>
		<div class="form-group" id="otp">
            <div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder='{__("OTP")}' name="otp">
            </div>
        </div>
		<div class="form-group">
          <button type="submit" class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill login" disabled>{__("Login")}</button>
        </div>
        <!-- error -->
      ...
      <form class="js_ajax-forms" data-url="core/signup.php" method="POST">
         ...
         <div class="form-group">
            <div class="input-group">
              ...
              <select name="registration_method" id="regmethod" class="form-control" required>
                      ...
                      <option value="" disabled selected>{__("Register via")}</option>
                    <option value="ByPhone">{__("Mobile Number")}</option>
                    <option value="ByEmail">{__("Email")}</option>
              </select>
            </div>
        ...
        <!--div class="form-group"  id="r_first_name">
          <div class="input-group">
            ...
            <input name="first_name" type="text" class="form-control" placeholder='{__("First name")}' >
          </div>
        </div>
