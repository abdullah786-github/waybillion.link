...
<link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    ...
    {/if}
    <!-- CSS -->
	<link rel="stylesheet" type='text/css' href="{$system['system_url']}/content/themes/{$system['theme']}/css/blogmenu.css">
	<link rel="stylesheet" type='text/css' href="{$system['system_url']}/content/themes/{$system['theme']}/css/blogtab.css">
	<link rel="stylesheet" type='text/css' href="{$system['system_url']}/content/themes/{$system['theme']}/css/normalize.css">
