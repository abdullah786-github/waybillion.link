...
<div class="post-header" data-aos="fade-up"
 ...
 <h1>  <a class="title mb5" href="{$system['system_url']}/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">{$_post['article']['title']}</a></h1>
 </div>
 </div>
  <!-- post picture -->
  ...
  <div class="post-meta">
    ...
    {else}
      <span class="js_user-popover" data-type="{$_post['user_type']}" data-uid="{$_post['user_id']}">
        By <a class="post-author" href="{$_post['post_author_url']}"> {$_post['post_author_name']}</a>
      </span>
    ...
    {elseif $_post['post_type'] == "link" && $_post['link']}
     ...
     data-aos-duration="1000" href="{$_post['link']['source_url']}" target="_blank" rel="nofollow">
    ...
    {elseif $_post['post_type'] == "media" && $_post['media']}
     ...
     data-aos-duration="1000">
            <div class="post-media-image" data-aos="fade-up" data-aos-duration="1000">
              <div class="image" style="background-image:url('{$_post['media']['source_url']}');" data-aos="fade-up" data-aos-duration="1000"></div>
            </div>
            <div class="post-media-meta" data-aos="fade-up"
     data-aos-duration="1000">
        ...
        {else}
          ...
          {elseif in_array($_post['media']['source_provider'], ["Facebook", "Vimeo", "Twitch", "Rumble.com", "Banned.Video", "brighteon", "Odysee"])}
            <div class="post-media">
              <div class="embed-responsive embed-responsive-16by9">
                {html_entity_decode($_post['media']['source_html'], ENT_QUOTES)}
              </div>
      ...
      <div class="mt10">
        <div class="post-media">
          {if $_post['article']['cover']}
            <a class="post-media-image" href="{$system['system_url']}/blogs/{$_post['post_id']}/{$_post['article']['title_url']}" data-aos="fade-up" data-aos-duration="1000">
              {*<div style="padding-top: 50%; background-size: cover; background-image:url('{$system['system_uploads']}/{$_post['article']['cover']}');" data-aos="fade-up" data-aos-duration="1000"></div>*}
			  
			  <img style="width:100%;" class="cover-box-img" src='{$system['system_uploads']}/{$_post['article']['cover']}'/>
            </a>
          {/if}
          <div class="post-media-meta" data-aos="fade-up"
     data-aos-duration="1000">
           {* <a class="title mb5" href="{$system['system_url']}/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">{$_post['article']['title']}</a>*}
            <div class="text mb5 js_readmore"><a class="post_text_custom" href="{$system['system_url']}/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">{$_post['article']['parsed_text']|truncate:5000}</a>
			{if $_post['article']['parsed_tags']}
		  <div class="article-tags">
			<ul>
			  {foreach $_post['article']['parsed_tags'] as $tag}
				<li>
    ...
    {elseif $_post['post_type'] == "funding" && $_post['funding']}
      <div class="mt10">
        <div class="post-media">
          <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank" data-aos="fade-up" data-aos-duration="1000">
            <div class="image" style="background-image:url('{$system['system_uploads']}/{$_post['funding']['cover_image']}');" data-aos="fade-up" data-aos-duration="1000"></div>
            <div class="icon">
    ...
    {elseif $_post['post_type'] == "offer" && $_post['offer']}
      <div class="mt10">
        <div class="post-media">
          <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank" data-aos="fade-up" data-aos-duration="1000">
            <div class="image" style="background-image:url('{$system['system_uploads']}/{$_post['offer']['thumbnail']}');" data-aos="fade-up" data-aos-duration="1000"></div>
            <div class="source">
     ...
     data-aos-duration="1000">
			...
			<button id="offer_pay" style="display:none;" class="offer_pay btn btn-primary btn-block mb10" data-toggle="modal" data-url="posts/product.php?do=offer_pay&amount={$custom_field['value']}">
                <i class="fa fa-piggy-bank mr5"></i>{__("BUY NOW")}
            </button>
			<style>
...
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/blitzer/jquery-ui.css"
    ...
    {elseif $_post['post_type'] == "job" && $_post['job']}
      <div class="mt10">
        <div class="post-media">
          <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank" data-aos="fade-up" data-aos-duration="1000">
            <div class="image" style="background-image:url('{$system['system_uploads']}/{$_post['job']['cover_image']}');" data-aos="fade-up" data-aos-duration="1000"></div>
            <div class="source">
      ...
      <div class="post-product-container">
        ...
        {if $_post['product']['available'] && $_post['author_id'] != $user->_data['user_id'] }
          <div class="mt10 clearfix">
			...
			<button class="btn btn-block btn-info" data-toggle="modal" data-url="#payment" data-options='{literal}{{/literal}"handle": "product", "id": {$_post["post_id"]}, "price": "{$_post["product"]["price"]}", "name": "{$_post["product"]["name"]}", "img": "{$system["system_uploads"]}/{$_post["photos"][0]["source"]}"{literal}}{/literal}'>BUY NOW</button>
          </div>
        {/if}
      </div>
    {/if}
