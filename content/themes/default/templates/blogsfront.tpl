      ...
      <div class="container mt20 offcanvas">
        <div class="row">
          ...
          {if $view == ""}
			...
			<div class="col-md-12 mb20 tabbing-column ff">
		  {if $pages}
              <ul>
                ...
                <div class="js_ajax-forms-html " data-url="posts/article.php?do=edit&id={$article['post_id']}">
                  <div class="card-body">
                    ...
                    <div class="form-group form-row">
                      ...
                      <div class="col-md-10">
                        <input class="form-control" name="title" value="aaaaa">
                      </div>
                    </div>
                ...
                <div class="js_ajax-forms-html" data-url="posts/article.php?do=create">
                  <div class="card-body">
                    ...
                    <div class="form-group form-row">
                      ...
                      <div class="col-md-10">
                        <input class="form-control" placeholder="Enter youtube video URL" name="videoURL">
                      </div>
                    </div>
