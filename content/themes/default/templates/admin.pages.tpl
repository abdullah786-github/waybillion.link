              ...
              <div class="col-md-9">
                <select class="form-control" name="category[]" multiple>
                  {foreach $data['categories'] as $category}
                    {include file='__categories.recursive_new_options.tpl' data_category=$data['article']['all_cats']}
                  {/foreach}
                </select>
              </div>
            </div>
      ...
      <div class="card-body">
        ...
        <div class="form-group form-row">
                ...
                <div class="col-md-10">
                  ...
                  {else}
                    <div class="x-image" style="background-image: url('{$system['system_uploads']}/{$data['category_icon']}')">
