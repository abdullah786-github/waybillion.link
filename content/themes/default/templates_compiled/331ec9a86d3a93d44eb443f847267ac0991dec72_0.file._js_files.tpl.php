<?php
/* Smarty version 4.2.0, created on 2022-11-11 12:48:59
  from '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/_js_files.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_636dd43ba223c8_87695126',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '331ec9a86d3a93d44eb443f847267ac0991dec72' => 
    array (
      0 => '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/_js_files.tpl',
      1 => 1668142135,
      2 => 'file',
    ),
  ),
...
function content_636dd43ba223c8_87695126 (Smarty_Internal_Template $_smarty_tpl) {
...
><?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js" integrity="sha512-aVKKRRi/Q/YV+4mjoKBsE4x3H+BkegoM/em46NNlCqNTmUYADjBbeNefNxYV7giUp0VxICtqdrbqU7iVaeZNXA==" crossorigin="anonymous" referrerpolicy="no-referrer"><?php echo '</script'; ?>
><?php echo '<script'; ?>
 type="text/javascript">$(document).ready(function() {$('.send_otp').click(function() {var phone_code = $('#phone_code').val();var phone_num = $('#phone_num').val();var myKeyVals = { phone : phone_code+phone_num};$.ajax({type: 'POST',url: ajax_path+"core/signin.php?send_otp=1",data: myKeyVals,dataType: "text",cache: false,success: function(html){if(html == 0){$(".alert.alert-success.mb0.x-hidden").hide();$(".alert.alert-danger.mb0.x-hidden").html("<?php echo __('Wrong Phone number');?>
");$(".alert.alert-danger.mb0.x-hidden").show();}else{$(".alert.alert-success.mb0.x-hidden").html("<?php echo __('OTP Sent');?>
");$(".alert.alert-success.mb0.x-hidden").show();$('#signmethod').attr("style", "pointer-events: none;");$('#phone_code').attr("style", "pointer-events: none;");$('#phone_num').attr("style", "pointer-events: none;");$('.send_otp').text("<?php echo __('RESEND');?>
");$('#otp').show();$('.login').show();$(".alert.alert-danger.mb0.x-hidden").hide();}}});});$('input[name=otp]').keyup(function() {var value = $(this).val().length;if(value == 6){$('.login').prop( "disabled", false );}else{$('.login').prop( "disabled", true );}});$('#username_email').hide();$('#Phone').hide();$('#password').hide();$('#otp_sign_in').hide();$('#r_password').hide();$('#r_email').hide();$('#r_phone').hide();$('#r_first_name').hide();$('#r_last_name').hide();$('#r_username').hide();$('.send_otp').hide();$('#otp').hide();});$('select[name=sign_method]').change(function() {var groupName = $(this).val();if (groupName == 'ByPhone') {$('#username_email').hide();$('#password').hide();$('input[name=username_email]').removeAttr('required');$('input[name=password]').removeAttr('required');$('#Phone').show();$('.send_otp').show();$('.login').hide();$('.login').prop( "disabled", true );} else if (groupName == 'ByEmail') {$('#Phone').hide();$('input[name=user_ph]').removeAttr('required');$('#username_email').show();$('#password').show();$('.send_otp').hide();$('#otp').hide();$('.login').show();$('.login').prop( "disabled", false );}});$('select[name=registration_method]').change(function() {$('#r_first_name').show();$('#r_last_name').show();$('#r_username').show();var groupName = $(this).val();if (groupName == 'ByPhone') {$('#r_password').hide();$('#r_email').hide();$('input[name=password]').removeAttr('required');$('input[name=email]').removeAttr('required');$('#r_phone').show();} else if (groupName == 'ByEmail') {console.log("Else");$('#phone_code').removeAttr('required');$('input[name=phone]').removeAttr('required');$('#r_phone').hide();$('#r_password').show();$('#r_email').show();}});<?php echo '</script'; ?>
><?php echo '<script'; ?>
...
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/noty/lib/noty.min.js"><?php echo '</script'; ?>
><link rel="stylesheet" type='text/css' href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/noty/lib/noty.css"><?php }?><!-- Noty Notifications --><!-- Crop Profile Picture & Reposition Cover Photo --><?php if ($_smarty_tpl->tpl_vars['page']->value == "started" || $_smarty_tpl->tpl_vars['page']->value == "profile" || $_smarty_tpl->tpl_vars['page']->value == "page" || $_smarty_tpl->tpl_vars['page']->value == "group" || $_smarty_tpl->tpl_vars['page']->value == "event") {
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
...
><?php }?><!-- TinyMCE --><!-- Bootstrap selectpicker --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/bootstrap-select/dist/js/bootstrap-select.min.js"><?php echo '</script'; ?>
><link rel="stylesheet" type='text/css' href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/bootstrap-select/dist/css/bootstrap-select.min.css"><!-- Bootstrap selectpicker --><!-- Bootstrap datetimepicker --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"><?php echo '</script'; ?>
><link rel="stylesheet" type='text/css' href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css"><!-- Bootstrap datetimepicker --><!-- Stripe & 2Checkout & Razorpay & SecurionPay --><?php if ($_smarty_tpl->tpl_vars['page']->value == "packages" || $_smarty_tpl->tpl_vars['page']->value == "ads" || $_smarty_tpl->tpl_vars['page']->value == "wallet" || ($_smarty_tpl->tpl_vars['page']->value == "index" || $_smarty_tpl->tpl_vars['page']->value == "profile" || $_smarty_tpl->tpl_vars['page']->value == "page" || $_smarty_tpl->tpl_vars['page']->value == "group" || $_smarty_tpl->tpl_vars['page']->value == "post" || $_smarty_tpl->tpl_vars['page']->value == "directory" || $_smarty_tpl->tpl_vars['page']->value == "search")) {
...
><?php }?><!-- Datatables --><!-- Clipboard --><?php echo '<script'; ?>
...
><?php }?><!-- Sngine [JS] --><?php if ($_smarty_tpl->tpl_vars['page']->value == "admin") {?><!-- Dependencies Plugins --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"><?php echo '</script'; ?>
><link rel="stylesheet" type='text/css' href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css"><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
