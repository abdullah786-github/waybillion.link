<?php
/* Smarty version 4.2.0, created on 2022-11-11 19:13:41
  from '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/_sign_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_636e2e65658542_97447386',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '632ef95dc8280142596f15cb490d3cd73d225c47' => 
    array (
      0 => '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/_sign_form.tpl',
      1 => 1668165124,
      2 => 'file',
    ),
  ),
...
function content_636e2e65658542_97447386 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <form class="js_ajax-forms" data-url="core/signin.php" method="POST">
         ...
         <div class="form-group">
            <div class="input-group">
              ...
              <select name="sign_method" id="signmethod" class="form-control" required>
                  
                      <option value="" disabled selected><?php echo __("Login via");?>
</option>
                    <option value="ByPhone"><?php echo __("Mobile Number");?>
</option>
                    <option value="ByEmail"><?php echo __("Email");?>
</option>
              </select>
            </div>
          </div>
          
        <div class="form-group" id="username_email">
          <div class="input-group">
            <div class="input-group-prepend">
         ...
         <div class="form-group"  id="Phone">
          <div class="input-group">
            <div class="input-group-prepend">
              ...
              <select name="user_ph" id="phone_code" class="form-control">
                <?php
...
" <?php if ($_smarty_tpl->tpl_vars['country']->value['default']) {?>selected<?php }?>><?php echo __(((string)$_smarty_tpl->tpl_vars['country']->value['country_name']));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <input id="phone_num" name="phone" type="text" class="form-control" placeholder='<?php echo __("Phone number");?>
'>
          </div>
        </div>
...
/reset"><?php echo __("Forgotten password?");?>
        ...
        <div class="form-group">
          <h2 class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill send_otp"><?php echo __("Send");?>
</h2>
        </div>
		<div class="form-group" id="otp">
            <div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder='<?php echo __("OTP");?>
' name="otp">
            </div>
        </div>
		<div class="form-group">
          <button type="submit" class="btn btn-block btn-primary bg-gradient-blue border-0 rounded-pill login" disabled><?php echo __("Login");?>
</button>
        </div>
        <!-- error -->
...
" required>
        ...
        <?php }?>
         ...
         <div class="form-group">
            <div class="input-group">
              ...
              <select name="registration_method" id="regmethod" class="form-control" required>
                  
                      <option value="" disabled selected><?php echo __("Register via");?>
</option>
                    <option value="ByPhone"><?php echo __("Mobile Number");?>
</option>
                    <option value="ByEmail"><?php echo __("Email");?>
        ...
        <!--div class="form-group"  id="r_first_name">
          <div class="input-group">
            <div class="input-group-prepend">
...
' >
        ...
        <div class="form-group" id="r_last_name">
          <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><i class="fas fa-user fa-fw"></i></span>
            </div>
...
' >
        ...
        <div class="form-group" id="r_username">
          <div class="input-group">
            <div class="input-group-prepend">
...
' required>
        ...
        <div class="form-group" id="r_email">
          <div class="input-group">
            <div class="input-group-prepend">
...
' required>
        ...
        <div class="form-group" id="r_password">
          <div class="form-group">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-key fa-fw"></i></span>
