<?php
/* Smarty version 4.2.0, created on 2022-11-12 13:37:36
  from '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/blogs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_636f3120f18ea1_68636900',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a1e1c4e7711e401cae911fd44c30ec5c5d133da0' => 
    array (
      0 => '/home/u246756914/domains/waybillion.link/public_html/content/themes/default/templates/blogs.tpl',
      1 => 1668231455,
      2 => 'file',
    ),
  ),
...
function content_636f3120f18ea1_68636900 (Smarty_Internal_Template $_smarty_tpl) {
...
"  style="height:35px; width:35px;" /> <?php }?><span><?php echo __($_smarty_tpl->tpl_vars['category']->value['category_name']);?>
</span></div>
            </a></li>
                    </a></li>
                  <?php
...
$_smarty_tpl->tpl_vars['category']->do_else = false;
?>
                     <?php if ($_smarty_tpl->tpl_vars['category']->value['category_name'] == $_smarty_tpl->tpl_vars['article']->value['article']['category_name']) {?>
                     <a class="article-category" href="https://waybillion.link/blogs/category/<?php echo $_smarty_tpl->tpl_vars['category']->value['category_id'];?>
/<?php echo $_smarty_tpl->tpl_vars['category']->value['category_name'];?>
">
                           
                      <img src="<?php echo $_smarty_tpl->tpl_vars['category']->value['category_icon'];?>
" style="width:35px;height:35px;" /> <?php echo $_smarty_tpl->tpl_vars['article']->value['article']['category_name'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <option value=""><?php echo __("Browse other Categories");?>
</option>
                     <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['categories']->value, 'category');
$_smarty_tpl->tpl_vars['category']->do_else = true;
...
$_smarty_tpl->tpl_vars['category']->do_else = false;
?>
                     <option value="<?php echo __($_smarty_tpl->tpl_vars['category']->value['category_name']);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                      ...
                      <!-- article title -->
                      <h2 class="article_title"><?php echo $_smarty_tpl->tpl_vars['article']->value['article']['title'];?>
</h2>
                      <!-- article title -->
...
" class="btn btn-sm btn-rounded btn-social-icon btn-pinterest" target="_blank">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['article']->value['article']['media_type']) {?>
                      <!-- article cover video -->
                      <?php if ($_smarty_tpl->tpl_vars['article']->value['article']['cover_video']) {?>
                        <div class="mb20">
                            <iframe class="cover-video" width="560" height="315" src="<?php echo $_smarty_tpl->tpl_vars['article']->value['article']['cover_video'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['article']->value['article']['title'];?>
...
$__foreach_reaction_10_saved = $_smarty_tpl->tpl_vars['reaction'];
?>
...
?>
                              ...
                              <?php
$_smarty_tpl->tpl_vars['reaction'] = $__foreach_reaction_10_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            </div>
                            <!-- reactions-container -->
...
$_smarty_tpl->tpl_vars['article']->do_else = false;
$_smarty_tpl->tpl_vars['article']->iteration++;
$__foreach_article_12_saved = $_smarty_tpl->tpl_vars['article'];
?>
...
?>
                  <?php
$_smarty_tpl->tpl_vars['article'] = $__foreach_article_12_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  <!-- read more -->
                </div>
...
">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-10">
                            <label class="switch">
                              <input class="checkbox_cover" type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article']['media_type'];?>
" name="media_type">
                    ...
                    <div class="form-group form-row cover_video" style="display:none;">
                      <label class="col-md-2 form-control-label">
                        <?php echo __("youtube video");?>

                      </label>
                      <div class="col-md-10">
                        <input class="form-control" placeholder="Enter youtube video URL" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article']['cover_video'];?>
" name="cover_video">
                      </div>
                    </div>

                    <div class="form-group form-row cover_image">
                      <label class="col-md-2 form-control-label">
                        <?php echo __("Cover");?>
...
">
      			  ...
      			  <div class="form-group form-row">
                      ...
                      <div class="col-md-10">
                        <select class="form-control" name="category[]" multiple style="height:250px;">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="form-group form-row">
                            ...
                            <div class="col-md-10">
                                <label class="switch">
                                  <input class="checkbox_cover" type="checkbox" value="0" name="media_type">
                                  <span class="slider"></span>
                                </label>
                            </div>
                    </div>
                    ...
                    <div class="form-group form-row cover_video" style="display:none;">
                      ...
                      <div class="col-md-10">
                        <input class="form-control" placeholder="Enter youtube video URL" name="cover_video">
                      </div>
                    </div>
...
>
  ...
  $( document ).ready(function() {
       $('.checkbox_cover').on('change', function() {
        ...
        if($('.checkbox_cover').val() == "1"){
            console.log("asfsadf");
            $('.checkbox_cover').prop("checked", true).trigger('change');
        }
